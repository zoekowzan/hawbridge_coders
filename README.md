...
====================
Each week, I will submit a pull request to your repository with changes from dmlond/hawbridge_coders that I have made to add new features, or edit the instructions and documentation. You should login to your Github hawbridge_coders account, and click on the [Pull requests](/pulls) link. Here you will see any open pull requests that I (or others, possibly) have created (you can also see closed pull requests by clicking on 'closed' at the top). Click on the pull request, and it will give you the option of merging the changes that I have made into your repository.  You can then commit these merged changes, with a comment. This will change your `master` branch, and add new `version-` branches that I have created since you first forked the dmlond/hawbridge_coders repo, or accepted a previous pull request from me. It might change other `version-` branches if I have found bugs or updated the documentation for them.
